<template>
  ...
  >
    <div class="container">
      ...
      <div class="jour">
        <h2 class="text-white text-light-shadow">{{ weather.name }}</h2>
        <h1 class="text-white text-light-shadow">{{ format(now) }}</h1>
      </div>
      <div v-if="typeof weather.main != 'undefined'">
        <div class="flex-row justify-content-center">
          <h2 class="text-white">
            <span
              class="box-shadow padding-20 backgroun-color-white border-radius-10 font-size-big text-light-shadow"
...
.body-clouds {
  ...
  linear-gradient(to bottom, #929191, #979696, #9b9a9a, #a09f9f, #a5a4a4, #aaa9a9, #afaeaf, #b4b3b4, #bab9ba, #c0c0c1, #c7c6c7, #cdcdcd);
}  
.body-rain {
  font-family: "Anton", sans-serif;
  background-size: 1020px;
...
.body-snow {
  ...
  linear-gradient(to bottom, #ababab, #b0b0b0, #b6b6b6, #bbbbbb, #c1c1c1, #c6c6c6, #cbcbcb, #d0d0d0, #d5d5d5, #dbdbdb, #e0e0e0, #e6e6e6);
}        
h1,h2 {
  text-align: center;
}
